...
This project is hosted on [GitHub](https://github.com/btrainwilson/loom) and these (common) rules apply:

* Do use the [issues tracker](https://github.com/btrainwilson/loom/issues).
* Let's discuss any proposed change or fix in an issue, so your work is not done in vain - I hate to reject pull requests...
* Create [pull requests](https://github.com/btrainwilson/loom/pulls) against `main` branch.
